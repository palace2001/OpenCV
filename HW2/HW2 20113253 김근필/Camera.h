...
#define FRONT_DIR -1.0f

class Camera
{
public:
  Camera()
    : position_(0,2,0), front_dir_(0,0,-1), up_dir_(0,1,0), right_dir_(1,0,0), fovy_(45), yaw_(0)
  {}
  ...
  const glm::vec3&  right_direction() const   { return  glm::cross(front_dir_, up_dir_); }	
